...
const cards: CardSeed[] = [
  ...
  },
  {
    ...
    title: 'Three Knocks',
    prompt:
      'Something knocks three times at your door tonight. Talk us through exactly what you do, in order, until you know what it is.',
  ...
  // ─── SOLO · DO ────────────────────────────────────────────────────────────
  {
    ...
    prompt:
      'Cameras off. Open any drawing tool and draw the monster that lives in your building, before the clock runs out. Then hold it up.',
  ...
  },
  {
    ...
    prompt:
      'Find an image and set it as your video background so that it camouflages the shirt you are wearing right now.',
  ...
  },
  {
    ...
    wins: 'Scored 1-5. Everyone lives with your name for the rest of the night, so make it count.',
    secs: 45,
    needsDevice: false,
  },
  {
    ...
    prompt:
      'Build the most alarming edible thing you can from exactly three items in your kitchen, before the clock runs out. You must take one bite on camera.',
  ...
  },
  {
    ...
    prompt:
      'Conduct a serious, respectful interview with a household appliance about its afterlife.',
  ...
  },
  {
    ...
    title: 'The Entrance',
    prompt:
      'Leave the frame. Return, before the clock runs out, with the most dramatic entrance you can physically manage.',
  ...
  },
  {
    ...
    title: 'Desk Cinema',
    prompt:
      'Recreate an iconic horror scene using only what is currently on your desk, then hold the final tableau.',
  ...
  },
  {
    ...
    title: 'Final Girl',
    prompt:
      'Write four rhyming lines on exactly why you would be the last one alive. Then read them aloud, with feeling.',
  ...
  // ends on a peak instead of trailing off.
  {
    ...
    prompt:
      'Both of you: fetch one object. Convince the room that yours is the more dangerous cursed artifact.',
  ...
  },
  {
    ...
    prompt:
      'You are both in the same horror film. Argue why you outlive the other one.',
  ...
  },
  {
    ...
    prompt:
      'You have both died and elected to haunt this company. Say precisely how you would do it.',
  ...
  },
  {
    ...
    lane: 'say',
    heat: 2,
    title: 'What Is In This Room',
    prompt:
      'A party starts the moment this card ends, and you can only use what is in the room you are sitting in. Describe the costume.',
  ...
  // ─── DUEL, ADDED ──────────────────────────────────────────────────────────
  {
    ...
    lane: 'do',
    heat: 2,
    title: 'This Room: Head To Head',
    prompt:
      'Talk the room into your last-minute costume, built from what is in your room right now. You may hold things up.',
